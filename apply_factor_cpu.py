...
python3 apply_factor.py -i 1-3 --seeds 10,20 --output ../outputs/apply_factor --truncation 1.0 --ckpt ../models/ern.pkl ../models/erc-feature-vector.pt --no-video
python3 apply_factor_cpu.py -i 0-511 --seeds 3923 --output ../outputs/apply_factor --truncation 1.0 --ckpt ../models/ern.pkl ../models/ern-feature-vectors.pt --no-video
...
def generate_images(z, label, truncation_psi, noise_mode, direction, file_name):
    if(args.space == 'w'):
        ws = zs_to_ws(G,torch.device('cpu'),label,truncation_psi,[z,z + direction,z - direction])
...
if __name__ == "__main__":
    ...
    for l in latents:
        ...
        for j in index_list_of_eigenvalues:
            print(f'Generate images for eigenvector {j}')
